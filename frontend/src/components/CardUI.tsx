...
function CardUI()
{
    ...
    async function addCard(e:any) : Promise<void>
    {
        ...
        try
        {
            const response = await fetch(buildPath('api/addCard'),//'http://localhost:5000/api/addcard',
    ...
    async function searchCard(e:any) : Promise<void>
    {
        ...
        try
        {
            const response = await fetch(buildPath('api/searchCards'),//'http://localhost:5000/api/searchcards',
            {method:'POST',body:js,headers:{'Content-Type': 'application/json'}});
